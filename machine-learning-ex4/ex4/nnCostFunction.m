...
Delta_3 = H_theta - Y';
Delta_2 = Theta2(:,2:end)' * Delta_3 .* sigmoidGradient(Theta1 * A_1);
...
Theta1_grad = (1/m) * (Theta1_grad + (lambda * Theta1_mod));
Theta2_grad = (1/m) * (Theta2_grad + (lambda * Theta2_mod));
